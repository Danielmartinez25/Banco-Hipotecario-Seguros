...
export default function Question() {
  ...
  return (
    <>
      <div
        className={`flex flex-col items-center justify-center pt-5 ${styles.serviceContainer}`}
      >
        <h2 className={`text-center ${styles.title}`}>Preguntas Frecuentes</h2>
        <div className="p-4">
          ...
          <div className="text-center mt-4">
            ...
            >
              ...
              <i
                className={`fa fa-xs fa-chevron-right rotate-arrow ${styles.arrow}`}
                aria-hidden="true"
              ></i>
            </button>
            ...
            {displayText && (
              <div className={`${styles.textPanel}`}>
                ...
                <p>
                  Para respaldar tu economía ante un imprevisto de salud. Cubre
                  la falta o complementa la prestación del sistema de salud
                  público, tu obra social o medicina prepaga. Ante el primer
                  diagnóstico de cáncer, infarto de miocardio, derrame e infarto
                  cerebral, cirugía o un trasplante te pagamos una suma
                  asegurada y con el dinero podrás hacer frente a todos los
                  gastos adicionales e imprevistos que siempre surgen.
                </p>
                ...
                <ul>
                  ...
                  <li>¡Te vas a poder hacer 2 chequeos anuales preventivos!</li>
                </ul>
              </div>
            )}
          </div>
          <div className="text-center mt-4">
            ...
            {displayTextTwo && (
              <div className={`${styles.textPanel}`}>
                ...
                <p>
                  Para solicitar o consultar sobre tu asistencia podés llamar al
                  0810.666.0066.
                </p>
                <br />
                <p>
                  El servicio puede ser utilizado por el asegurado de la póliza,
                  pero, en caso de que necesites, podés coordinar una
                  videoconsulta con un médico especialista para vos o cualquier
                  integrante de tu grupo familiar.
                </p>
                ...
                <h3>
                  Si tengo obra social o pre paga ¿Puedo contratar el seguro de
                  salud?
                </h3>
                <p>
                  Si, lo podés contratar, es complementario al sistema de salud
                  pública, tu obra social o prepaga.
                </p>
                <h3>¿A partir de qué momento está vigente la cobertura?</h3>
                <p>
                  La vigencia de la póliza es a partir de las 0 (cero) horas del
                  día siguiente de la contratación.
                </p>
              </div>
            )}
          </div>
          <div className="text-center mt-4">
            ...
            {!displayTextThree && <div className={styles.divResponsive}></div>}
            ...
            {displayTextThree && (
              <div className={`${styles.textPanel}`}>
                ...
                <ol>
                  ...
                  <li>
                    Descargá y completá el formulario de denuncia de siniestro,
                    firmalo y envialo por mail a:
                    <a
                ...
                <p>
                  ...
                  directamente al titular si éste estuviera, por caso de fuerza
                  mayor, imposibilitado de hacerla.
                </p>
                <h3>
                  ¿Qué pasa si se produce un siniestro estando impago el premio
                  de la póliza?
                </h3>
                <p>
                  La cobertura se suspende en forma automática desde la hora 24
                  del día del vencimiento impago. Verificá en tu póliza la
                  cláusula de cobranza, a fin de evitar un rechazo por falta de
                  pago.
                </p>
              </div>
            )}

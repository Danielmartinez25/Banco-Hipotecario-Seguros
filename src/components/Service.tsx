...
export default function Service() {
  ...
  return (
    <>
      <div
        className={`flex flex-col items-center justify-center pt-2 ${styles.serviceContainer}`}
      >
        ...
        <div className="p-4">
          <p className={` ${styles.description}`}>
            Este servicio es el complemento a la cobertura que contratás con tu
            seguro y te permite contar con:
          </p>
          <div className="text-center mt-4">
            ...
            >
              ...
              <i
                className="fa fa-chevron-right rotate-arrow"
                aria-hidden="true"
              ></i>
            </button>
            ...
            {displayText && (
              <div className={`${styles.textPanel}`}>
                ...
                <p>
                  Atención ante urgencias odontológicas, incluyendo radiografías
                  (Periapicales y Coronales), Endodoncia (Tratamiento de
                  Conducto), Operatoria Dental (Obturación simple compuesta y
                  compleja), Periodoncia (Tratamiento gingivitis), Cirugías:
                  dientes (permanentes/temporales); (radiculares/fracturados),
                  Limpieza.
                </p>
                <h3>Asistencia nutricional</h3>
                <p>
                  Con planes orientativos de alimentación saludable indicando
                  calorías recomendadas en cada comida, Información práctica de
                  recetas clásicas adaptadas a las distintas patologías (por
                  ejemplo, celiaquía y diabetes) y asesoramiento sobre productos
                  disponibles en el mercado para cada caso.
                </p>
          ...
          <div className="text-center mt-4">
            ...
            {displayTextTwo && (
              <div className={`${styles.textPanel}`}>
                ...
                <p>
                  Que incluye electrocardiograma, hemograma y análisis de orina
                  completo, RX de tórax, ecografía abdominal y ecografía
          ...
          <div className="text-center mt-4">
            ...
            {displayTextThree && (
              <div className={`${styles.textPanel}`}>
                ...
                <p>
                  Te sumamos el más completo servicio de telemedicina para vos y
                  para tu grupo familiar, las 24hs, los 365 días del año.
                </p>

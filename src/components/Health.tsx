...
export default function Health() {
  return (
    <>
      <div
        className={`d-flex flex-column align-items-center ${styles.healthContainer}`}
      >
        <h2 className={styles.title}>Más asistencias en tu seguro de salud</h2>
        ...
        <div className={`row mb-1 mt-4 w-100`}>
          <div className={`col-12 col-md-3 mb-3 ${styles.boxHealth}`}>
            <Image alt="heart" src={imageHeart} width={106} height={79} />
            <p>Sesiones de psicología</p>
          </div>
          <div className={`col-12 col-md-3 mb-3 ${styles.boxHealth}`}>
            <Image alt="computer" src={imageComputer} width={106} height={79} />
